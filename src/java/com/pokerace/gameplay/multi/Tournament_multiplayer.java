 ...
 */
package com.pokerace.gameplay.multi;
 ...
 * @author lokesh
 */
public class Tournament_multiplayer extends MultipotTournament {
	public Tournament_multiplayer(int total_games, String tournament_id, String tournament_name, int maxPlayers, int minPlayers, Double credits, Server_State serverState) {
		super(TournamentMode.MULTI, total_games, tournament_id, tournament_name, maxPlayers, minPlayers, credits, serverState, 0);
	}
	...
	public void start_tournament() throws InterruptedException {
		...
		while (this.game_number <= this.total_games) {
			try {
				...
				Log.getLog("InvalidPokerException", "Tournament", MIN_PRIORITY);
			}
